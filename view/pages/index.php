                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>Nombre de prêt total depuis l'inscription</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-camera-retro fa-fw"></i> Locations Photobooth
                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-group fa-fw"></i> Vos Groupes de soirée
                        </div>
                        <div class="panel-body">
                             <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
